...
def dailyOddsNCAAMar3(day, month, year, odds_file, first_run = False):
    ...
    #Query page
    #URL ='https://classic.sportsbookreview.com/betting-odds/ncaa-basketball/?date=20210303'
    URL ='https://classic.sportsbookreview.com/betting-odds/ncaa-basketball/?date='+year+month+day
    ...
    #Getting overs +year+month+day
    URL = 'http://classic.sportsbookreview.com/betting-odds/ncaa-basketball/totals/?date=20210303?'
    URL = 'http://classic.sportsbookreview.com/betting-odds/ncaa-basketball/totals/?date='+year+month+day
    ...
    #Getting moneylines
    URL = 'https://classic.sportsbookreview.com/betting-odds/ncaa-basketball/money-line/?date=20210303'
    URL = 'https://classic.sportsbookreview.com/betting-odds/ncaa-basketball/money-line/?date='+year+month+day
    #URL = 'http://classic.sportsbookreview.com/betting-odds/ncaa-basketball/totals/?date=20201229?'
    driver = webdriver.Chrome(ChromeDriverManager().install())
    driver.get(URL)
    # driver.set_window_position(0, 0)
    ...
    #Combine everything
    result
    s = pd.DataFrame({'Date': Dates,'Away':teams_away,
            'Home' :teams_home, 
             'Home_Spread': home_spread, 
             'Over': overs,
            'Away_ML': away_line,
            'Home_ML': home_line}, 
            columns = ['Date','Away','Home','Home_Spread',  'Over','Away_ML','Home_ML'])
